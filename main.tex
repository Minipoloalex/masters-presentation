...
\begin{frame}{Metafeatures}
  ...
  There are well-established metafeatures in fields like classification and regression.
...
\begin{frame}{Literature Review}
  Metafeatures are well-established for classical ML fields such as classification and regression %
  but not RL

  However, there are many studies on properties that impact RL algorithm performance:
  \begin{itemize}
    \item Complexity Measures: . Not efficiently computable for an unknown problem
    \item Benchmarks: isolate environment properties and evaluate their impact on algorithms
  \end{itemize}

  Implicit knowledge of what impacts algorithm performance and no clear computable measures
\end{frame}
