...
\begin{frame}{Results Discussion}
  \begin{itemize}
    ...
    \item The algorithm selection methodology is capable of gaining significant performance over %
    the best-performing algorithm in some cases
    \item Some projections yield weaker selection performance, likely due to the predominance of %
...
\begin{frame}{Acknowledgment}
  ...
  \centering
  \includegraphics[width=0.8\linewidth]{figures/project-logos.pdf}
\end{frame}
