...
\section{Results}
\begin{frame}{Analyzing Instance Space Analysis Results}
  The ISA methodology requires defining specific hyperparameters.
  Based on iteration, we defined the most important parameters:
  \begin{itemize}
...
\begin{frame}{Individual Environments}{Sources and Best Algorithms}
  \begin{columns}[c,onlytextwidth]
    \column{.49\textwidth}
      \centering
...
\begin{frame}{Individual Environments}{Features Distribution}
  \centering
  \begingroup
